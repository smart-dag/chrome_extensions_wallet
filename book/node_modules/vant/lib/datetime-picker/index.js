  ...
  methods: {
    correctValue: function correctValue(value) {
      ...
      if (isDateType && !(0, _utils2.isValidDate)(value)) {
        ...
        value = (0, _utils.padZero)(this.minHour) + ":00";
      } // time type
      ...
      if (!isDateType) {
        ...
        hour = (0, _utils.padZero)((0, _utils.range)(hour, this.minHour, this.maxHour));
        minute = (0, _utils.padZero)((0, _utils.range)(minute, this.minMinute, this.maxMinute));
        return hour + ":" + minute;
      } // date type
    ...
    updateColumnValue: function updateColumnValue(value) {
      ...
      if (this.type === 'time') {
        ...
        values = [formatter('year', "" + value.getFullYear()), formatter('month', (0, _utils.padZero)(value.getMonth() + 1)), formatter('day', (0, _utils.padZero)(value.getDate()))];

        if (this.type === 'datetime') {
          values.push(formatter('hour', (0, _utils.padZero)(value.getHours())), formatter('minute', (0, _utils.padZero)(value.getMinutes())));
        }
