...
var _default = sfc({
  ...
  methods: {
    ...
    onTouchMove: function onTouchMove(event) {
      ...
      this.offset = (0, _utils.range)(this.startOffset + this.deltaY, -(this.count * this.itemHeight), this.itemHeight);
      var now = Date.now();
    ...
    getIndexByOffset: function getIndexByOffset(offset) {
      return (0, _utils.range)(Math.round(-offset / this.itemHeight), 0, this.count - 1);
    },
